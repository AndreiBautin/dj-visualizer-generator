 ...
 */
export const SURFACE_BASE = 'rounded-xl border border-white/10 bg-white/[0.04] shadow-sm shadow-black/20'
export const SURFACE_RAISED = 'rounded-lg border border-white/15 bg-white/[0.07] shadow-md shadow-black/30'
export const SURFACE_SUNKEN = 'rounded-lg border border-white/10 bg-white/[0.03]'
